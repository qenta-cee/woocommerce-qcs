...
class WC_Gateway_Wirecard_Checkout_Seamless_Skrilldirect {
	...
	/**
	 * WC_Gateway_Wirecard_Checkout_Seamless_Skrilldirect constructor.
	 *
	 * @since 1.0.0
	 *
	 * @param $settings
	...
	public function get_label() {
		return __( 'Skrill Direct', 'woocommerce-wirecard-checkout-seamless' );
	}
	...
	public function get_payment_type() {
		return WirecardCEE_QMore_PaymentType::SKRILLDIRECT;
	}
