...
/**
 * Class WC_Gateway_Qenta_Checkout_Seamless_Installemnt
 *
 * @since 1.0.0
 */
class WC_Gateway_Qenta_Checkout_Seamless_Installment {
	...
	/**
	 * WC_Gateway_Qenta_Checkout_Seamless_Installment constructor.
	 *
	 * @since 1.0.0
	 *
	 * @param $settings
	...
	public function get_label() {
		return __( 'Installment', 'woocommerce-qenta-checkout-seamless' );
	}
	...
	public function get_risk() {
		...
		} elseif ( $this->_settings['woo_wcs_installmentprovider'] == 'qenta' ) {
