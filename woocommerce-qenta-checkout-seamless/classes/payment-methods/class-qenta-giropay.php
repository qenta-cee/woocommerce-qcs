...
/**
 * Class WC_Gateway_Qenta_Checkout_Seamless_Giropay
 *
 * @since 1.0.0
 */
class WC_Gateway_Qenta_Checkout_Seamless_Giropay {
	...
	/**
	 * WC_Gateway_Qenta_Checkout_Seamless_Giropay constructor.
	 *
	 * @since 1.0.0
	 *
	 * @param $settings
	...
	public function get_label() {
		return __( 'giropay', 'woocommerce-qenta-checkout-seamless' );
	}
	...
	public function get_icon() {
		return WOOCOMMERCE_GATEWAY_QMORE_URL . "assets/images/giropay_h32.png";
	}
	...
	public function get_payment_fields() {
		...
		$html .= "<label>" . __( 'Account owner:', 'woocommerce-qenta-checkout-seamless' ) . "</label>";
