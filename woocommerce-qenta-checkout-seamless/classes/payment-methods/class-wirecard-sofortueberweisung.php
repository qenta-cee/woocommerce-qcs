...
/**
 * Class WC_Gateway_Qenta_Checkout_Seamless_Sofortueberweisung
 *
 * @since 1.0.0
 */
class WC_Gateway_Qenta_Checkout_Seamless_Sofortueberweisung {
	...
	/**
	 * WC_Gateway_Qenta_Checkout_Seamless_Sofortueberweisung constructor.
	 *
	 * @since 1.0.0
	 *
	 * @param $settings
	...
	public function get_label() {
		return __( 'SOFORT Banking', 'woocommerce-qenta-checkout-seamless' );
	}
