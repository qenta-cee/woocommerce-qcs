...
/**
 * Class WC_Gateway_Qenta_Checkout_Seamless_Credit_Card
 *
 * @since 1.0.0
 */
class WC_Gateway_Qenta_Checkout_Seamless_Ccard {
	...
	/**
	 * WC_Gateway_Qenta_Checkout_Seamless_Ccard constructor.
	 *
	 * @since 1.0.0
	 *
	 * @param $settings
	...
	public function get_label() {
		return __( 'Credit Card', 'woocommerce-qenta-checkout-seamless' );
	}
	...
	public function get_icon() {
		return WOOCOMMERCE_GATEWAY_QMORE_URL . "assets/images/cc_h32.png";
	}
	...
	public function get_payment_fields( $storage_id ) {
        ...
        wp_add_inline_script( 'parse' . $payment_type . 'JS', $jsParse );
			...
			<p class="form-row form-row-first">
				<label>' . __( 'Expiration date', 'woocommerce-qenta-checkout-seamless' ) . ' <span class="required">*</span></label>
				<input 
			...
			if ( $this->_settings['woo_wcs_cc_display_issue_date_field'] ) {
				$html .= '
					<p class="form-row form-row-first">
						<label>' . __( 'Issue date', 'woocommerce-qenta-checkout-seamless' ) . '</label>
						<input 
							class="input-text wc-credit-card-form-card-expiry"
							type="text" 
							autocomplete="off" 
			...
			if ( $this->_settings['woo_wcs_cc_display_issue_number_field'] ) {
				$html .= "<p class='form-row form-row-last'>";
				$html .= "<label>" . __( 'Issue number:', 'woocommerce-qenta-checkout-seamless' ) . "</label>";
