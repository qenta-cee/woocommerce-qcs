...
/**
 * Class WC_Gateway_Qenta_Checkout_Seamless_Idl
 *
 * @since 1.0.0
 */
class WC_Gateway_Qenta_Checkout_Seamless_Idl {
	...
	/**
	 * WC_Gateway_Qenta_Checkout_Seamless_Idl constructor.
	 *
	 * @since 1.0.0
	 *
	 * @param $settings
	...
	public function get_label() {
		return __( 'iDeal', 'woocommerce-qenta-checkout-seamless' );
	}
	...
	public function get_icon() {
		return WOOCOMMERCE_GATEWAY_QMORE_URL . 'assets/images/iDEAL_h32.png';
	}
	...
	public function get_payment_type() {
		return QentaCEE\QMore\PaymentType::IDL;
	}
