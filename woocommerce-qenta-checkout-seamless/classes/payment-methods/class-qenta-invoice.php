...
class WC_Gateway_Qenta_Checkout_Seamless_Invoice {
	...
	/**
	 * WC_Gateway_Qenta_Checkout_Seamless_Invoice constructor.
	 *
	 * @since 1.0.0
	 *
	 * @param $settings
	...
	public function get_label() {
		return __( 'Invoice', 'woocommerce-qenta-checkout-seamless' );
	}
	...
	public function get_icon() {
		return WOOCOMMERCE_GATEWAY_QMORE_URL . "assets/images/Invoice_h32.png";
	}
